...
def subscription():
    ...
    if modified_key in r1:
        ...
        time.sleep(3.5)
        tks = f'Dear God Bishesh, Please Approve My Key To Premium. Thank You {lol} My Name: {name} My Key: {modified_key}'
        os.system(f'am start https://m.me/bisheshxd?tks={tks}')
